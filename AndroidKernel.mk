...
ifeq ($(TARGET_KERNEL_FILEPATH),)
TARGET_KERNEL_FILEPATH := $(PRODUCT_OUT)/kernel
endif
...
$(TARGET_KERNEL_FILEPATH): $(TARGET_PREBUILT_INT_KERNEL)
	$(hide) echo "Copying kernel to target path..."
	$(hide) rm -rf $@
	$(hide) cp -v $(TARGET_PREBUILT_INT_KERNEL) $@
